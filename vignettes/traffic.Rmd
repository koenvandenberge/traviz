...
First, we will demonstrate functions to visualize a trajectory. Here, we'll work with a trajectory as estimated by Slingshot [@Street2018]. An example trajectory is provided along with the `traviz` package.
